  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-5 sm:px-8 py-16 sm:py-24">
        ...
        <section className="mt-16 rounded-2xl bg-panel text-panel-foreground p-8 sm:p-10 text-center">
          <h2 className="font-display font-bold text-2xl sm:text-3xl">{d.servicePage.readyH2}</h2>
          <p className="mt-3 text-panel-foreground/70 text-sm sm:text-base">{d.servicePage.readyDesc}</p>
