  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-5 sm:px-8 py-16 sm:py-24">
        ...
        <section className="mt-16 relative rounded-3xl bg-panel text-panel-foreground p-8 sm:p-12 overflow-hidden">
          ...
          <div className="relative">
            <div className="font-mono text-xs text-panel-foreground/60 uppercase tracking-widest">{d.about.nextSection}</div>
            <h2 className="mt-3 font-display font-bold text-3xl sm:text-4xl leading-tight">{d.about.nextH2}</h2>
            <p className="mt-4 text-panel-foreground/70 leading-relaxed">{d.about.nextDesc}</p>
